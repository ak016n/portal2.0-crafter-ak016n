...
DELETE FROM dev_core.user WHERE id IN ('1', '2', '3', '4');
DELETE FROM dev_core.organization WHERE id IN ('1');


-- ADMIN user
INSERT INTO dev_core.user(id, login, password, email) VALUES ('1', 'raj_test', '{SSHA}Uexh4IbjBJU4l7DIq50itbMfFIMPEdoq+hYd4Q==', 'raj.test@att.com');
INSERT INTO dev_core.user_role_relationship (user_id, role_id) VALUES ('1', '1');

-- member
INSERT INTO dev_core.user(id, login, password, email) VALUES ('2', 'leonard_test', '{SSHA}Uexh4IbjBJU4l7DIq50itbMfFIMPEdoq+hYd4Q==', 'leonard.test@att.com');

INSERT INTO dev_core.user(id, login, password, email) VALUES ('3', 'penny_test', '{SSHA}Uexh4IbjBJU4l7DIq50itbMfFIMPEdoq+hYd4Q==', 'penny.test@att.com');

INSERT INTO dev_core.user(id, login, password, email) VALUES ('4', 'howard_test', '{SSHA}Uexh4IbjBJU4l7DIq50itbMfFIMPEdoq+hYd4Q==', 'howard.test@att.com');
